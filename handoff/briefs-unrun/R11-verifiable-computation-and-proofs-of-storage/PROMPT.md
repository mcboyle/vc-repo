# R11 — Verifiable computation and proofs of storage
...
Survey SNARKs, STARKs, recursive proof composition, cryptographic accumulators, vector commitments,
polynomial commitments, proofs of retrievability, proofs of replication, verifiable erasure proofs,
and homomorphic MACs — assessed specifically for disk encryption at realistic volume sizes. Three
concrete questions: can I prove a volume was correctly re-encrypted without re-reading it; can I
prove cloud-hosted ciphertext is still intact without downloading it; and can I prove data was
genuinely erased? Be blunt about which of these are research-only at disk scale in 2026 and which
have practical implementations. Include proving time, proof size, and verification cost for anything
you recommend.
