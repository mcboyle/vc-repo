...
MODULES="HardwareKeyFactor KeyScrub DuressToken Keyslot KeyslotStore AfSplit KeyslotAreaFile Shamir ShamirMac ShareCode SelfTest VcStatus VcJson HeaderBackup HkfOrSet VcPosture KeyslotAreaMac VolumeLabel AtomicHeader Pkcs5"
...
FLAGS="VC_ENABLE_KEYSCRUB VC_ENABLE_HKF VC_ENABLE_DURESS VC_ENABLE_KEYSLOTS VC_ENABLE_KEYSLOT_POLICY VC_ENABLE_SHAMIR_MAC VC_ENABLE_SHARECODE VC_ENABLE_HKF_SALT_BIND VC_ENABLE_ARGON2_PARAMS VC_ENABLE_BALLOON_KDF VC_ENABLE_SELFTEST VC_ENABLE_KEYSLOT_SHRED VC_ENABLE_STATUS VC_ENABLE_JSON VC_ENABLE_HEADER_BACKUP VC_ENABLE_HKF_ORSET VC_ENABLE_POSTURE VC_ENABLE_VERIFY VC_ENABLE_KEYSLOT_AREA_MAC VC_ENABLE_VOLUME_LABEL VC_ENABLE_ATOMIC_HEADER VC_ENABLE_HKF_LEN_CONDITION VC_ENABLE_HKF_SALT_BIND_DEFAULT VC_ENABLE_HKF_MIX_V2"
