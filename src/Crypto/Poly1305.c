/*
 * Poly1305 one-shot MAC (RFC 8439), radix-2^26 "donna" 32-bit limbs. Shippable form of the proven
 * verification header verification/poly1305.h (suite step [18]). See Poly1305.h for scope/gating.
 */
